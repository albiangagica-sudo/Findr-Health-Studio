...
import { Zap, ShieldCheck, Activity, TrendingUp, Sparkles, ArrowRight, UserPlus, Target, MousePointer2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-24">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3 py-1 bg-cobalt/10 text-cobalt rounded-full text-[10px] font-black uppercase tracking-widest mb-6"
          >
            <Zap size={14} /> The Platform
          </motion.div>
          <h1 className="text-6xl md:text-8xl font-display font-bold tracking-tight leading-[0.85] mb-8">
            Precision audits. <br />
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          ...
          <motion.div 
            ...
            className="md:col-span-2 p-12 bg-lavender rounded-[3.5rem] border border-gray-100 flex flex-col md:flex-row items-center gap-16 min-h-[450px] shadow-2xl shadow-black/[0.02] relative overflow-hidden group"
          >
            <div className="absolute top-0 right-0 w-80 h-80 bg-findr/5 blur-3xl rounded-full translate-x-32 -translate-y-32" />
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-findr-light text-findr-dark rounded-full text-[10px] font-black uppercase tracking-widest mb-8">
                <TrendingUp size={12} /> Family Finance
              </div>
            ...
            <div className="flex-1 bg-gray-50 rounded-[3rem] h-full w-full relative overflow-hidden group/img min-h-[300px]">
               <img 
                 src="/api/image-proxy?id=1tIhRtYTRpW7qDDF2RA1aL-Ht3kWJV48M" 
                 alt="Family Wellness" 
        ...
        {/* New Expanded Content: The 3-Step Journey */}
        <div className="mb-32">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tight mb-6">How to win with Findr.</h2>
            <p className="text-gray-500 font-medium text-lg">Three steps to your first big health win.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="text-center">
              <div className="w-20 h-20 bg-lavender/20 text-cobalt rounded-[2rem] flex items-center justify-center mx-auto mb-8 shadow-sm">
                <UserPlus size={32} />
              </div>
              <h4 className="text-2xl font-display font-bold mb-4">Connect Care</h4>
              <p className="text-gray-500 leading-relaxed font-medium">Securely link your insurance portal or upload a PDF of your latest bill. We handle the CPT codes.</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-zest text-black rounded-[2rem] flex items-center justify-center mx-auto mb-8 shadow-zest/20 shadow-lg">
                <Target size={32} />
              </div>
              <h4 className="text-2xl font-display font-bold mb-4">Identify Discrepancies</h4>
              <p className="text-gray-500 leading-relaxed font-medium">Our AI flags upcoding, unbundling, and balance billing errors that often go unnoticed by human auditors.</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-findr text-white rounded-[2rem] flex items-center justify-center mx-auto mb-8 shadow-findr/20 shadow-lg">
                <MousePointer2 size={32} />
              </div>
              <h4 className="text-2xl font-display font-bold mb-4">Claim Your Win</h4>
              <p className="text-gray-500 leading-relaxed font-medium">Use our pre-filled dispute templates or talk to our partners to resolve errors and get your money back.</p>
            </div>
          </div>
        </div>
        ...
        <motion.div 
          whileHover={{ y: -5 }}
          className="p-16 bg-black rounded-[4rem] text-white overflow-hidden relative"
        >
          <div className="absolute top-0 right-0 w-80 h-80 bg-findr opacity-10 blur-3xl rounded-full" />
          <div className="relative z-10 text-center max-w-2xl mx-auto">
            <Sparkles className="text-zest mb-8 mx-auto" size={48} />
            <h2 className="text-4xl md:text-6xl font-display font-bold mb-8 leading-tight">Ready to find <br /> your first win?</h2>
            <button className="px-12 py-6 bg-findr text-white rounded-[2rem] font-black text-xl shadow-findr/20 shadow-2xl hover:scale-105 transition-transform flex items-center justify-center gap-3 mx-auto">
              Start Free Audit <ArrowRight size={24} />
            </button>
          </div>
        </motion.div>
      </div>
