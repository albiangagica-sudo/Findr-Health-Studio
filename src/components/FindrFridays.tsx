      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
             ...
             <p className="text-gray-500 font-medium text-lg leading-relaxed mb-12 italic max-w-[320px] md:max-w-xl mx-auto">"I saved $450 on my son's dental surgery last month. Findr Fridays just treated us to a full family organic meal kit. It feels like we're finally winning."</p>
             ...
             <div className="flex flex-col sm:flex-row items-center gap-6">
                <div className="flex -space-x-4">
                  {[1,2,3,4].map(i => (
                    <img 
                      key={i} 
                      src={`https://picsum.photos/seed/person-${i + 10}/100`} 
                      className="w-12 h-12 rounded-full border-4 border-[#FBFBFE] shadow-lg" 
                      referrerPolicy="no-referrer"
                    />
                  ))}
                </div>
