      ...
      <AnimatePresence>
        {isVisible && (
          <motion.button
            ...
            className="fixed bottom-8 right-8 z-[100] w-16 h-16 bg-zest text-black rounded-2xl shadow-[0_20px_40px_rgba(212,255,89,0.3)] flex items-center justify-center group active:scale-90 transition-transform"
          >
